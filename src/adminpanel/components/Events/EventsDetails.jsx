    ...
    <div className="rounded-xl p-4 bg-gray-50 min-h-screen">
      ...
      <div className=" flex flex-col gap-3">
           ...
           2 Days
            ...
            <p className="text-gray-600">
            Location: <span className="font-medium">{data.location_venue}</span>{" "}
            </p>
            <p className="text-gray-600">
            Url: <a className="font-medium text-blue-600" href={data.url}>{data.url}</a>{" "}
            </p>

           
            <p className="text-gray-600">
            <span className="font-medium">{data.host_name} {data.host_organization}</span>
            </p>
            <p className="text-gray-600">
            Description: <span className="font-medium">{data.details_description}</span>{" "}
            </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center w-96 justify-between bg-white shadow-md p-4 rounded-lg">
            ...
            <div>
            <p className="font-semibold text-sm">Tech design requirements</p>
            <p className="text-xs">200 KB</p>
            </div>
