      ...
      return (
        <div className="rounded-xl p-4 bg-gray-50 min-h-screen">
          ...
          <div className="flex space-x-4 mb-4">
            ...
            <div className="bg-[#4B0082] text-center text-white shadow-md  rounded-xl flex flex-col justify-center items-center p-2 h-16"><p className='text-nowrap'>Student Corner </p><p className='font-bold'>100</p></div>
