      ...
      <div className="flex flex-col  justify-center items-center">
        ...
        >
          <div className="relative min-h-[549px]">
            ...
            <img src="/card/employeeupper.svg" className="max-xsm:w-full" alt="" />
          </div>
        </div> : <div
          id="backcover"
          onMouseLeave={() => { setShow(true) }}
          className="  bg-red-100 border   border-gray-500 rounded-[30px] overflow-hidden max-xsm:w-[90%] max-xsm:h-fit "
        >
          <div className="relative">
            <img src="/card/employeelower.svg" className=" max-xsm:w-full w-[391px] h-[190px] max-sm:h-fit" alt="" />
            ...
            <img src="/card/employeeupper.svg" className=" max-xsm:w-full w-[391px] h-[91px] max-xsm:h-fit" alt="" />
          </div>
        </div>}
