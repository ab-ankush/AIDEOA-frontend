      ...
      <div className="grid grid-cols-2 gap-40 max-lg:gap-20  max-md:grid-cols-1">
        ...
        <div className="   flex justify-center ">
          <div className="space-y-8  xl:w-3/4 ">
            ...
            <div className="  bg-red-200 w-1/2 bg-red-200 lg:min-w-80 bg-gray-400 relative bg-blue-200 lg:rounded-r-2xl max-h-full max-lg:h-64 max-lg:rounded-b-2xl overflow-hidden max-lg:w-full opacity-70 hover:opacity-95  cursor-pointer">
              <Map />
              <Link
