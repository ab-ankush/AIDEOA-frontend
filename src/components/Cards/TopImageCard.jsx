...
const TopImageCard = ({image='/Rectangle128.png',title="Contact us",description,downloadBtn,position="center"}) => {
  return (
    <div className='relative mb-10 lg:mb-20 ' >
        {/* <img src={image} className={`h-80 imagefilter w-full object-cover bg-bottom`} alt={title}/> */}
        <div style={{backgroundImage:`url(${image})`,backgroundSize:"cover"}} className={`h-[550px] imagefilter w-full bg-${position} `} alt={title}/>
