...
const Section1 = () => {
  return (
    <div class="centerdiv mx-4 overflow-x-hidden flex flex-col justify-center items-center">
      <h1 class="text-[35px] my-3 font-bold">Our Mission</h1>
      <div class="pdiv flex justify-center items-center my-5">
