...
const Mutual_table = () => {
  ...
  return (
    <div className="m-5 mx-12 ">
      ...
      <input type="text" placeholder="Search Here..." className="p-3  max-sm:w-[300px] rounded-xl sm:max-lg:text-[16px] text-xl border w-[20%] shadow-xl  text-gray-600 border-gray-200"/>
